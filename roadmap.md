...
## طلبات 2026-09-08
- [x] إخفاء خدمة الفيديو مؤقتًا من واجهة الشات
- [x] ترتيب أزرار الخدمات بالعربية والإنجليزية بشكل نظيف وكامل
- [x] إتاحة وضع البرمجة لكل الحسابات بدون اشتراك بريميوم
- [ ] منع قفز وتجمّد سكرول الشات على الهاتف
- [ ] اختبار البرمجة والمعاينة والخدمات والـMCP بالحساب التجريبي

## 2026-09-08 — تقرير جاهزية النشر
- [x] مليار كريدت للحساب التجريبي
- [x] رسالة واضحة قابلة لإعادة المحاولة عند تعليق الدردشة
- [x] توحيد سعر الخطة على $7
- [x] منع تكرار المحادثات في القائمة الجانبية + تنظيف المكرر
- [x] شاشة تحميل باسم Megsy بدل الفراغ

- [x] إخفاء شريط التمرير في مربع الإدخال على الهاتف
