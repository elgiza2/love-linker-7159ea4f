...
- [ ] مليار كريدت للحساب التجريبي
- [ ] معالجة واضحة عند نفاد الرصيد + زر إعادة المحاولة عند فشل الدردشة
- [ ] توحيد سعر الخطة ($5 vs $7)
- [ ] منع تكرار المحادثات في القائمة الجانبية
- [ ] بديل للشاشة البيضاء أثناء التحميل

- [ ] إخفاء شريط التمرير في مربع الإدخال على الهاتف
